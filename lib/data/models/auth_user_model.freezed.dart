...
abstract class $AuthUserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String uuid});
}
...
class _$_AuthUserModel extends _AuthUserModel {
  const _$_AuthUserModel(
      {required this.id, required this.email, required this.uuid})
      : super._();
  ...
  @override
  String toString() {
    return 'AuthUserModel(id: $id, email: $email, uuid: $uuid)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, email, uuid);
...
abstract class _AuthUserModel extends AuthUserModel {
  const factory _AuthUserModel(
      ...
      required final String uuid}) = _$_AuthUserModel;
